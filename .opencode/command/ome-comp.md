...
Use Component Generation Workflow for the current project.

Trigger: `/ome-comp`
Terminal equivalent: `ome-comp <component-name>`
...
Task:
- Generate reusable components using project code and design rules.
