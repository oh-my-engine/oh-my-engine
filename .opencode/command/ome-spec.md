...
Use Spec Workflow for the current project.

Trigger: `/ome-spec`
Terminal equivalent: `ome-spec <command> [args]`
...
Task:
- Run OpenSpec-compatible proposal, plan, apply, verify, and archive workflows.
