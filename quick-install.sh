...
print_usage() {
    ...
    case $AGENT_TARGET in
        claude)
            echo -e "  ${GREEN}/ome-init${NC}    Initialize in your project"
            echo -e "  ${GREEN}/ome-ui${NC}      Restore UI from designs"
            echo -e "  ${GREEN}/ome-bug${NC}     Analyze and fix bugs"
            echo -e "  ${GREEN}/ome-comp${NC}    Generate components"
            echo -e "  ${GREEN}/ome-api${NC}     Integrate APIs"
            echo -e "  ${GREEN}/ome-spec${NC}    Run the spec workflow"
            echo -e "  ${GREEN}/ome-memory${NC}  View execution history"
            echo -e "  ${GREEN}/ome-evolve${NC}  Evolve workflows"
            ;;
        codex)
            echo -e "  ${GREEN}ome-init${NC}      Invoke the installed init skill"
            echo -e "  ${GREEN}ome-ui${NC}        Invoke the UI restore skill"
            echo -e "  ${GREEN}ome-bug${NC}       Invoke the bug analysis skill"
            echo -e "  ${GREEN}ome-comp${NC}      Invoke the component generator skill"
            echo -e "  ${GREEN}ome-api${NC}       Invoke the API integration skill"
            echo -e "  ${GREEN}ome-spec${NC}      Invoke the spec workflow skill"
            echo -e "  ${GREEN}ome-memory${NC}    Invoke the memory viewer skill"
            echo -e "  ${GREEN}ome-evolve${NC}    Invoke the evolution skill"
            ;;
        both)
            ...
            echo -e "  ${GREEN}/ome-evolve${NC}  Evolve workflows"
            echo ""
            echo -e "  ${GREEN}ome-init${NC}      Codex skill name"
            echo -e "  ${GREEN}ome-ui${NC}        Codex skill name"
            echo -e "  ${GREEN}ome-bug${NC}       Codex skill name"
            echo -e "  ${GREEN}ome-comp${NC}      Codex skill name"
            echo -e "  ${GREEN}ome-api${NC}       Codex skill name"
            echo -e "  ${GREEN}ome-spec${NC}      Codex skill name"
            echo -e "  ${GREEN}ome-memory${NC}    Codex skill name"
            echo -e "  ${GREEN}ome-evolve${NC}    Codex skill name"
            ;;
    esac
