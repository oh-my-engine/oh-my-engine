...
function buildMarkdown(options: MemoryRecord, guidance: MemoryRecord): string {
  const lines: string[] = [];
...
export function buildEngineMemoryContext(argv: string[] = process.argv.slice(2)): void {
