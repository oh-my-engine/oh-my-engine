...
const DIRECTIVE_PRESETS: Record<string, string[]> = {
...
function buildFallbackDirectives(record: MemoryRecord): string[] {
...
function buildGeneratedSkillArtifact(record: MemoryRecord, adoptedAt: string): MemoryRecord {
