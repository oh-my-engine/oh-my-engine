...
function buildCandidateSkillMarkdown(record: MemoryRecord): string {
  ...
  return [
    ...
    '2. Confirm the current task matches the candidate evidence.',
    ...
    '- The fix requires a new dependency that the user did not request.',
    '- The change expands into unrelated cleanup.',
    ...
    '- I can apply the pattern broadly across unrelated files.',
