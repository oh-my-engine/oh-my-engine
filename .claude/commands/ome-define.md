...
Use Define Workflow for the current project.

Trigger: `/ome-define`
Terminal equivalent: `ome define "<task or requirement>"`
...
Task:
- Clarify goal, scope, success criteria, and assumptions before implementation.
