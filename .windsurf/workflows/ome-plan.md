...
Use Plan Workflow for the current project.

Trigger: `/ome-plan`
Terminal equivalent: `ome plan "<task or requirement>"`
...
Task:
- Create implementation guidance with interfaces, edge cases, and test strategy.
