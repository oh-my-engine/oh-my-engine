...
Use API Integration Workflow for the current project.

Trigger: `/ome-api`
Terminal equivalent: `ome-api <api-spec-or-description>`
...
Task:
- Integrate API clients, services, and contracts using project rules.
