...
- TBD: list architecture, delivery, policy, or compatibility constraints.

## Image and Attachment Observations
- TBD: convert image or attachment findings into textual facts.

## Ambiguities
- TBD: list unresolved ambiguities that still need a decision.

## Open Questions
- TBD: capture questions that should be resolved before implementation.
