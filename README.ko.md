...
- **🧭 컨텍스트 기반 가이드**: `ome guidance --input`이 현재 작업과 관련된 학습 내용 및 생성된 스킬 지시를 우선 표시
...
- Codex 스킬 이름: `ome-init`, `ome-init-rules`, `ome-ui`, `ome-bug`, `ome-comp`, `ome-api`, `ome-spec`, `ome-memory`, `ome-evolve`, `ome-superpowers`, `ome-mcp`
