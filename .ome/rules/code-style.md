...
rule: code-style
version: 1.0.0
description: Code style rules for TypeScript Node.js projects
...
- Match the existing TypeScript style in src, docs, schemas, skills, examples, bin.
...
- Use the existing package manager (npm) and scripts instead of adding parallel tooling.
- Preserve existing module conventions detected in source: commonjs-exports, commonjs-require, esm-exports, esm-imports.
